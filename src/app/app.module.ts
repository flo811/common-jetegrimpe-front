...
const routes: Routes = [
  ...
  { path: 'produits/Accessoire', component: CategoriesComponent},
  { path: 'produits/Assurage', component: CategoriesComponent},
  { path: 'produits/Baudrier', component: CategoriesComponent},
